            ...
            <div class="as-search-results as-filter-open as-category-landing as-desktop" id="as-search-results">
                ...
                <div id="accessories-tab" class="as-accessories-details">
                    <div class="as-accessories" id="as-accessories">
                      <h3>Su pago se encuentra pendiente</h3>
                      <?php
		              ...
		              if (isset($_REQUEST['payment_id'])) {
	                    echo '<p>payment_id = '.$_REQUEST['payment_id'].'</p>';
	                  }
		              ...
		              if (isset($_REQUEST['collection_status'])) {
	                    echo '<p>collection_status = '.$_REQUEST['collection_status'].'</p>';
	                  }
		              if (isset($_REQUEST['payment_type'])) {
	                    echo '<p>payment_type = '.$_REQUEST['payment_type'].'</p>';
	                  }
		              if (isset($_REQUEST['payment_method_id'])) {
	                    echo '<p>payment_method_id = '.$_REQUEST['payment_method_id'].'</p>';
	                  }
		              if (isset($_REQUEST['merchant_order_id'])) {
	                    echo '<p>merchant_order_id = '.$_REQUEST['merchant_order_id'].'</p>';
	                  }
		              if (isset($_REQUEST['preference_id'])) {
	                    echo '<p>preference_id = '.$_REQUEST['preference_id'].'</p>';
	                  }
		              if (isset($_REQUEST['site_id'])) {
	                    echo '<p>site_id = '.$_REQUEST['site_id'].'</p>';
	                  }
		              if (isset($_REQUEST['processing_mode'])) {
	                    echo '<p>processing_mode = '.$_REQUEST['processing_mode'].'</p>';
	                  }
		              if (isset($_REQUEST['merchant_account_id'])) {
	                    echo '<p>merchant_account_id = '.$_REQUEST['merchant_account_id'].'</p>';
	                  }
		              ?>
                    </div>
                </div>
